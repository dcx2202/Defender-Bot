...
public class SimulacaoUnicaRobo {
    ...
    //Ataque
    public void escolheAtaque(SimulacaoUnicaInimigo inimigo) {
    ...
    public void ataqueSom(SimulacaoUnicaInimigo inimigo) {
        energAtual -= ENERSOM;
        inimigo.recebeDano(DANOSOM);
    }

    public void ataqueToque(SimulacaoUnicaInimigo inimigo) {
        energAtual -= ENERGTOQUE;
        inimigo.recebeDano(DANOTOQUE);
    }

    public void ataqueGrua(SimulacaoUnicaInimigo inimigo) {
